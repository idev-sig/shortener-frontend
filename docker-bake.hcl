...
target "_common" {
    labels = {
        "org.opencontainers.image.source" = "https://git.jetsung.com/idev/shortener-frontend"
        "org.opencontainers.image.documentation" = "https://git.jetsung.com/idev/shortener-frontend"
